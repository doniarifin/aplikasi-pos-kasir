...
class TransactionController extends Controller
{
    ...
    public function show(Transaction $transaction)
    {
        ...
        $total_price = TransDetail::selectRaw("SUM(price * trans_details.qty) as totalprice")->join('products', 'products.id', '=', 'product_id')->where('transaction_id', $transaction->id)->get();
        ...
        return view('admin.transaction.detail', compact('transaction', 'products', 'customers', 'transd', 'total_price'));
    }
